...
<!-- Navigation navbar-->
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <a class="navbar-brand" href="#!">Le parfum ultime</a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="#!">種類</a></li>
                            </ul>
                        </li>
                    </ul>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">加入購物車</a>
                                    <a class="btn btn-outline-danger mt-auto" href="{{route('products.show')}}" value="{{$product->id}}">查看商品</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
<!-- Footer-->
        ...
        <!-- Core theme JS-->
        <script src="js/shoppage.scripts.js"></script>
</body>
</html>
